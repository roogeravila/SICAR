...
$result = mysql_query($sql);
	...
	echo '<tr bgcolor="#CCCCCC" bordercolor="#FFFFFF ">
				...
				<td style="width:11%"><center>Opções</ce</td>
			</tr>';
	...
	while($row = mysql_fetch_array($result))
	{
	  ...
	  echo "<tr>
				...
				"?>
				 <?php 
				 if($row['req_status']=="1")
				 echo "<a href=FolhaRequerimento/requerimento_analisar.php?id=".$row["req_protocolo"]."><input class=art-button type=button cadastrar value=Analisar> </input></a>"?>
				<?php echo "</td>";
				"</tr>" ;
	}
	  echo '</table>';
