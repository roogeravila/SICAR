...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
        <h3 style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(180, 198, 202); padding-bottom: 5px; text-align: center;"><img width="161" height="23" style="border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px;" alt="" src="images/Novo%20Requerimento-3.png" class="">&nbsp;</h3>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><input type="file" name="req_anexo"></td>
        ...
        <input value="Enviar" type="submit" class="art-button"> <input value="Limpar" type="reset"  class="art-button"></h3>
        </form>
        
        
        <h3 style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(180, 198, 202); padding-bottom: 5px; text-align: left;"><a href="../index.html" style="font-size: 11px; ">Voltar</a><span style="font-size: 11px;"></span></h3>
    </div>
    </div>
</div>
</div>
